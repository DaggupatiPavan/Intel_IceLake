pipeline {
    ...
    stages {
        ...
        stage('Install ansible') {
            steps {
                script {
                    sh "ssh -o StrictHostKeyChecking=no ubuntu@${postgres_ip} -- 'sudo apt install ansible'"
                    sh "ssh -o StrictHostKeyChecking=no ubuntu@${hammer_ip} -- 'sudo apt install ansible'"
