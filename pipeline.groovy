...
def instance() {
    ...
    // Master node
    sh -c "ssh ubuntu@10.63.20.41 'cd /home/ubuntu/intel_icelake && echo \"[postgres]\" >> myinventory'"
    sh "ssh ubuntu@10.63.20.41 -- 'cd /home/ubuntu/intel_icelake && echo -n ' ansible_host='  >> myinventory'"
    sh "ssh ubuntu@10.63.20.41 -- 'cd /home/ubuntu/intel_icelake && terraform output -no-color -json instance_private_ip | tr -d '[]\"' | tr ',' '\n' | head -1 | sed 's/\$/ ansible_user=ubuntu/' >> myinventory"
    ...
    sh -c "ssh ubuntu@10.63.20.41 'cd /home/ubuntu/intel_icelake && echo \"[hammer]\" >> myinventory'"
