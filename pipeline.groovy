...
def instance() {
    ...
    // Master node
    sh "ssh ubuntu@10.63.20.41 'cd /home/ubuntu/intel_icelake && echo \"[postgres]\" >> myinventory'"
    ...
    sh "ssh ubuntu@10.63.20.41 'cd /home/ubuntu/intel_icelake && echo \"[hammer]\" >> myinventory'"
